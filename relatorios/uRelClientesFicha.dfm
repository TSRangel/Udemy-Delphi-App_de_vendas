object frmRelClientesFicha: TfrmRelClientesFicha
  ...
  object relatorio: TRLReport
    ...
    object ficha: TRLBand
      Left = 38
      Top = 96
      Width = 718
      Height = 181
      object rldbClienteId: TRLDBText
        Left = 91
        Top = 12
        Width = 52
        Height = 16
      ...
      object rldbDataDeNascimento: TRLDBText
        Left = 162
        Top = 128
        Width = 98
        Height = 16
      ...
      object lblDataDeNascimento: TRLLabel
        Left = 16
        Top = 128
        Width = 130
        Height = 16
  ...
  object qryClientesFicha: TFDQuery
    ...
    Left = 560
    Top = 400
    object qryClientesFichaclienteId: TFDAutoIncField
      FieldName = 'clienteId'
      Origin = 'clienteId'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = False
    end
    object qryClientesFichanome: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'nome'
      Origin = 'nome'
      Size = 60
    end
    object qryClientesFichacep: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'cep'
      Origin = 'cep'
      Size = 10
    end
    object qryClientesFichaendereco: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'endereco'
      Origin = 'endereco'
      Size = 60
    end
    object qryClientesFichabairro: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'bairro'
      Origin = 'bairro'
      Size = 40
    end
    object qryClientesFichacidade: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'cidade'
      Origin = 'cidade'
      Size = 50
    end
    object qryClientesFichaestado: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'estado'
      Origin = 'estado'
      Size = 2
    end
    object qryClientesFichaemail: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'email'
      Origin = 'email'
      Size = 100
    end
    object qryClientesFichatelefone: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'telefone'
      Origin = 'telefone'
      Size = 14
